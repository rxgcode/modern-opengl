...
int main()
{
    ...
    GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Bart Simpson", NULL, NULL);
...
void buildAllCurves()
{
    ...
    // Contorno
    contorno.push_back(p_control[8].x); // A�ade el punto 8 para controlar el GL_TRIANGLE_FAN
    contorno.push_back(p_control[8].y); // A�ade el punto 8 para controlar el GL_TRIANGLE_FAN
    ...
    // Barbilla
    barbilla.push_back(-0.3225); // a�ade para el triangle_fan
    barbilla.push_back(0.1475);  // a�ade para el triangle_fan
    ...
    barbilla.push_back(p_control[0].x); // a�ade para cerrar la figura al pintar con gltrianglefan
    barbilla.push_back(p_control[0].y); // a�ade para cerrar la figura al pintar con gltrianglefan

    // Ojo izquierdo
    ojo_izquierdo.push_back((p_control[14].x + p_control[17].x) / 2.0); // a�ade para el triangle_fan
    ojo_izquierdo.push_back((p_control[14].y + p_control[17].y) / 2.0); // a�ade para el triangle_fan
    ...
    ojo_izquierdo.push_back(p_control[14].x); // a�ade para cerrar la figura al pintar con gltrianglefan
    ojo_izquierdo.push_back(p_control[14].y); // a�ade para cerrar la figura al pintar con gltrianglefan

    // Ojo derecho
    ojo_derecho.push_back((p_control[20].x + p_control[23].x) / 2.0); // a�ade para el triangle_fan
    ojo_derecho.push_back((p_control[20].y + p_control[23].y) / 2.0); // a�ade para el triangle_fan
    ...
    ojo_derecho.push_back(p_control[20].x); // a�ade para cerrar la figura al pintar con gltrianglefan
    ojo_derecho.push_back(p_control[20].y); // a�ade para cerrar la figura al pintar con gltrianglefan

    // Nariz
    nariz.push_back(p_control[33].x); // a�ade para el triangle_fan
    nariz.push_back(p_control[33].y); // a�ade para el triangle_fan
